...
TOPOLOGIES = {
    ...
    "nsfnet": {
        "description": "NSFNET US Backbone (14 Nodes)",
        "p99_latency_threshold": 25.0,
        "nodes": [
            ("WA", 47.6062, -122.3321, "core", 12, 1),
            ("CA1", 37.4419, -122.1430, "core", 12, 1),
            ("CA2", 32.7157, -117.1611, "core", 12, 1),
            ("UT", 40.7608, -111.8910, "edge", 8, 2),
            ("CO", 40.0150, -105.2705, "edge", 8, 2),
            ("TX", 29.7604, -95.3698, "core", 10, 1),
            ("NE", 40.8136, -96.7026, "edge", 6, 3),
            ("IL", 40.1164, -88.2434, "core", 12, 1),
            ("MI", 42.2808, -83.7430, "edge", 8, 2),
            ("NY", 42.4440, -76.5019, "edge", 8, 2),
            ("NJ", 40.3573, -74.6672, "core", 10, 1),
            ("PA", 40.4406, -79.9959, "edge", 8, 2),
            ("DC", 38.9072, -77.0369, "core", 12, 1),
            ("GA", 33.7490, -84.3880, "edge", 8, 2),
        ]
    },
    "geant2": {
        "description": "GEANT2 European Research Network (23 Nodes)",
        "p99_latency_threshold": 35.0,
        "nodes": [
            ("UK", 51.5074, -0.1278, "core", 15, 1),
            ("IE", 53.3498, -6.2603, "edge", 10, 2),
            ("FR", 48.8566, 2.3522, "core", 15, 1),
            ("ES", 40.4168, -3.7038, "core", 12, 1),
            ("PT", 38.7223, -9.1393, "edge", 8, 2),
            ("BE", 50.8503, 4.3517, "edge", 10, 2),
            ("NL", 52.3676, 4.9041, "core", 12, 1),
            ("DE", 50.1109, 8.6821, "core", 15, 1),
            ("LU", 49.6117, 6.1319, "edge", 6, 3),
            ("CH", 46.2044, 6.1432, "core", 12, 1),
            ("IT", 41.9028, 12.4964, "core", 12, 1),
            ("AT", 48.2082, 16.3738, "edge", 10, 2),
            ("CZ", 50.0755, 14.4378, "edge", 10, 2),
            ("PL", 52.2297, 21.0122, "core", 10, 1),
            ("HU", 47.4979, 19.0402, "edge", 8, 2),
            ("RO", 44.4268, 26.1025, "edge", 8, 2),
            ("BG", 42.6977, 23.3219, "edge", 6, 3),
            ("GR", 37.9838, 23.7275, "edge", 10, 2),
            ("HR", 45.8150, 15.9819, "edge", 6, 3),
            ("SI", 46.0569, 14.5058, "edge", 6, 3),
            ("DK", 55.6761, 12.5683, "edge", 10, 2),
            ("SE", 59.3293, 18.0686, "core", 12, 1),
            ("NO", 59.9139, 10.7522, "edge", 10, 2),
        ]
    }
}
